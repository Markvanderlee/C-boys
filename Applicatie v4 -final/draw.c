...
/** Deze functie initailiseert de VGA.*/
void VGA_init()
{
	UB_VGA_Screen_Init();
}
...
/** Deze functie toont een lijn op het scherm op een aangegeven plek.

Input  		| Toelichting
------------- 	| -------------
x0 		| X waarde van het beginpunt van de lijn, gelimiteerd door de resolutie van het scherm.
y0	  	| Y waarde van het beginpunt van de lijn, gelimiteerd door de resolutie van het scherm.
x1	  	| X waarde van het eindpunt van de lijn, gelimiteerd door de resolutie van het scherm.
y1	  	| y waarde van het eindpunt van de lijn, gelimiteerd door de resolutie van het scherm.
dikte	  	| Bepaald de pixeldikte van de lijn. 
kleur	  	| Bepaald de kleur van de lijn, beperkt aantal kleuren zijn mogenlijk.
...
/** Deze functie toont een Cirkel op het scherm op een aangegeven plek.

Input  		| Toelichting
------------- 	| -------------
xStart 		| X waarde van het beginpunt van de cirkel, gelimiteerd door de resolutie van het scherm.
yStart	  	| Y waarde van het beginpunt van de cirkel, gelimiteerd door de resolutie van het scherm.
straal	  	| Bepaald de grote van de cirkel, gelimiteerd door de resolutie van het scherm. 
kleur	  	| Bepaald de kleur van de cirkel, beperkt aantal kleuren zijn mogenlijk.*/
...
/** Deze functie toont een driehoek op het scherm op een aangegeven plek.

Input  		| Toelichting
------------- 	| -------------
x0		| X waarde van het eerste punt van de driehoek, gelimiteerd door de resolutie van het scherm.
y0	  	| Y waarde van het eerste punt van de driehoek, gelimiteerd door de resolutie van het scherm.
x1	  	| X waarde van het tweede punt van de driehoek, gelimiteerd door de resolutie van het scherm. 
y1	  	| Y waarde van het tweede punt van de driehoek, gelimiteerd door de resolutie van het scherm. 
x2	  	| X waarde van het derde punt van de driehoek, gelimiteerd door de resolutie van het scherm. 
y2	  	| Y waarde van het derde punt van de driehoek, gelimiteerd door de resolutie van het scherm. 
kleur	  	| Bepaald de kleur van de driehoek, beperkt aantal kleuren zijn mogenlijk.*/
...
/** Deze functie toont een rechthoek op het scherm op een aangegeven plek.

Input  		| Toelichting
------------- 	| -------------
xStart		| X waarde van het begin van de rechthoek, gelimiteerd door de resolutie van het scherm.
yStart	  	| Y waarde van het begin van de rechthoek, gelimiteerd door de resolutie van het scherm.
xEind	  	| X waarde van het eindpunt van de rechthoek, gelimiteerd door de resolutie van het scherm. 
yEind	  	| Y waarde van het eindpunt van de rechthoek, gelimiteerd door de resolutie van het scherm. 
kleur	  	| Bepaald de kleur van de rechthoek, beperkt aantal kleuren zijn mogenlijk.*/
...
/** Deze functie toont een ellipse op het scherm op een aangegeven plek.

Input  		| Toelichting
------------- 	| -------------
x		| X waarde van het midden van de ellipse, gelimiteerd door de resolutie van het scherm.
y	  	| Y waarde van het midden van de ellipse , gelimiteerd door de resolutie van het scherm.
width	  	| Breedte van de ellipse, gelimiteerd door de resolutie van het scherm. 
height	  	| Hoogte van de ellipse, gelimiteerd door de resolutie van het scherm. 
kleur	  	| Bepaald de kleur van de ellipse, beperkt aantal kleuren zijn mogenlijk.*/
...
/** Deze functie toont tekst op het scherm op een aangegeven plek.

Input  		| Toelichting
------------- 	| -------------
x		| X waarde van de tekst, gelimiteerd door de resolutie van het scherm.
y	  	| Y waarde van de tekst , gelimiteerd door de resolutie van het scherm.
kleur	  	| Bepaald de kleur van de tekst, beperkt aantal kleuren zijn mogenlijk.*/
...
/** Deze functie toont een bitmap op het scherm op een aangegeven plek.

Input  		| Toelichting
------------- 	| -------------
x		| X waarde van de bitmap, gelimiteerd door de resolutie van het scherm.
y	  	| Y waarde van de bitmap , gelimiteerd door de resolutie van het scherm.
*/
...
/** Deze functie toont een tekst teken op het scherm op een aangegeven plek.

Input  		| Toelichting
------------- 	| -------------
x		| X waarde van het teken, gelimiteerd door de resolutie van het scherm.
y	  	| Y waarde van het teken , gelimiteerd door de resolutie van het scherm.
kleur		| Kleur die wordt meegegeven aan de tekst.
*/
void put_char_a_arial_normal( int x, int y, int kleur) {
	L00(x, (y+0), kleur);
	L16(x, (y+1), kleur);
